...
export function ReportsPage() {
  const reports = ['Monthly income report', 'Monthly expense report', 'Category-wise expense report', 'Savings report', 'Loan report', 'EMI report', 'Net worth report', 'Investment report', 'Cashflow report']
  return (
    <div>
