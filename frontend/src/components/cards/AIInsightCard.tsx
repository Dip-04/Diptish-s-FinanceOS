  ...
  return (
    <GlassCard className="overflow-hidden p-6">
      <div className="flex items-center gap-3">
        <span className="rounded-2xl bg-cyan-300/15 p-3 text-cyan-300"><Bot size={22} /></span>
        <div>
          <p className="text-sm uppercase tracking-[0.18em] text-cyan-200">AI financial brain</p>
      ...
      <div className="mt-5 flex items-center gap-2 text-sm font-medium text-violet-200">
        <Sparkles size={16} />
